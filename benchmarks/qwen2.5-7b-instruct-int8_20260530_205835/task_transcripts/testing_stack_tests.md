...
Prompt ID: `stack_tests`
Category: `testing`

## Prompt

```text
Write pytest tests for a Stack class with push, pop, peek, and is_empty methods. Cover normal behavior and edge cases.
```

## Conversation ID

`cd6b51bdcccb4e9393461cf9babcc2db`
