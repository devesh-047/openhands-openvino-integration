...
I'm writing before putting together a formal proposal because I want to make sure I'm going in the right direction — and also just to check whether this project is actually likely to have a slot this year before I spend more time on it.
...
**Should I keep going with this project?** The prototype is promising but I've put maybe 1.5 weeks into it and haven't done the hardest part (end-to-end agent testing) yet. If the project isn't likely to have a slot, or if my approach is off, I'd rather know now. I'm also open to discussing other OpenVINO project ideas if you think something else would be a better fit.
